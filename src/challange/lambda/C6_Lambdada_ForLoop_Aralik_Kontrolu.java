...
// limit() ile belirliyoruz
    public static void main(String[] args) {
        ...
        int num2 = 35;
        System.out.print("S3 : ");
        System.out.print(IntStream.rangeClosed(num1, num2).sum());
        System.out.println("\n \t\t\t***");

        //-->S4 30 ile 40 arasindaki sayilarin (dahil) ortalamasini bulalim
        System.out.print("S4 : ");
        System.out.print(IntStream.rangeClosed(30, 40).average());
        System.out.println("\n \t\t\t***");
        ...
        System.out.print("S8 : ");
        System.out.println(IntStream.rangeClosed(7, 15).filter(t -> t % 2 == 1).reduce(1, (t, u) -> t * u));
        System.out.println("\n \t\t\t***");
