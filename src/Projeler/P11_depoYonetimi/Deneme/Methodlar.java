...
import static Projeler.P11_depoYonetimi.Deneme.TryCatch.sayiGir;
...
public class Methodlar {
    ...
    static void urunGirisi() {
        ...
        if (urunListesi.size() == 0)
            System.out.println("Giris yapabilecek herhangi bir ürün tanimlamadiniz");
        else {
            while (true) {
                ...
                if (!urunListesi.containsKey(secim)) {
                    ...
                    System.out.println("Lütfen gecerli Id giriniz");
                } else break;
            }
    ...
    static void urunuRafaKoy() {
        ...
        int raf = 0;
        if (urunListesi.size() == 0)
            System.out.println("Tanimlanmis herhangi bir ürün bulunmamaktadir");
        else {
            while (true) {
                System.out.println("Lütfen islem yapmak istediginiz ürünün Id sini seciniz:");
                secim = sayiGir();
    ...
    static void urunCikisi() {
        ...
        int miktar = 0;
        if (urunListesi.size() == 0)
            System.out.println("Yababileceginiz ürün cikisi bulunmuyor");
        else {
            while (true) {
                System.out.println("Lütfen islem yapmak istediginiz ürünün Id sini seciniz:");
                secim = sayiGir();
    ...
    static void urunSorgulama() {
        ...
        if (urunListesi.size() > 0) {
            ...
            while (true) {
                ...
                if (urunListesi.containsKey(secim)) {
                    ...
                    System.out.println("Ürün sistemde bulunmamaktadir");
                    System.out.println("Ana Menuye dönmek icin \"9\"a basiniz");
                    if (secim == 9) {
                        Menu.islemMenusu();
                        break;
                    }
        ...
        else System.out.println("Henüz herhangi bir ürün girisi yapmadiniz...");
    }
